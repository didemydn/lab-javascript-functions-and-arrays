...
console.log(maxOfTwoNumbers(4,20));
...
function howManyTimes(findingwords,awordtosearch) {
  let times = 0; 
  for(let i = 0; i < findingwords.length; i++){
    if(findingwords[i] === awordtosearch){
      times = times + 1;
    }
  }
return times;
